<template>
  <TopSection
    ...
    cls="menu-header"
    title="Tag kontakt"
    img="https://i.postimg.cc/wBqx8bxm/get-in-touch.png"
  />
  <div
    class="container-space font text-secondary pt-16 pb-16 text-center mt-16"
  >
    <v-row>
      ...
      <v-col cols="12" md="6" lg="6">
        <div class="d-flex justify-end">
          <div class="d-flex flex-column align-start heading-5">
            ...
            <span
              >Email
              <a href="mailto:kontakt@apoli.dk" class="text-decoration-none"
                ><span class="text-blue-grey-lighten-1"
                  >kontakt@apoli.dk</span
                ></a
              ></span
            >
            <span
      ...
      <v-col cols="12" md="6" lg="6">
        <div class="d-flex flex-column align-center heading-5">
          <div class="d-flex align-center flex-column mt-16 ga-16">
            ...
            ></iframe>
            <v-btn variant="flat" @click="redirectToMaps" color="#819d7c"
              >Se på kortet</v-btn
            >
          </div>
        </div>
  ...
  <div class="container-space bg-sec-primary pt-6 font-c-secondary w-100">
    <div class="d-flex justify-center mt-10">
      <div class="">
        ...
        <div class="text-grey-darken-1 text-center">
          Tag kontakt til restaurant
        </div>
      </div>
    </div>
      ...
      <v-form>
        <v-container>
          ...
          <div class="mt-8 d-flex justify-center">
            <v-btn class="text-none" color="#819d7c" variant="flat"
              >Submit</v-btn
            >
          </div>
        </v-container>
...
function redirectToMaps() {
  window.open("https://maps.app.goo.gl/fDiwLatZZajq17FM6", "_blank");
}
